...
class RemoveSearchTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_search_functionality(self):
        ...
        # Locate the search bar again to delete the search history
        search_input = self.driver.find_element(By.CSS_SELECTOR, ".search-box input")
        search_input.click()
        remove_btn = self.driver.find_element(By.CLASS_NAME, "remove-hist")
        remove_btn.click()

        
        # Locate the search bar again to check the search history
        search_input = self.driver.find_element(By.CSS_SELECTOR, ".search-box input")
        search_input.click()

        history_list = self.driver.find_element(By.ID, "history-list")
        assert_that(history_list.text.strip()).is_equal_to("No search history")
